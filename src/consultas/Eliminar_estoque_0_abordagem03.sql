...
WHERE
	TPE.DT_POSICAO_ESTOQUE BETWEEN SYSDATE - 15 AND SYSDATE AND tp3.DS_PRODUTO IS NOT NULL
UNION
SELECT 
	CASE
...
WHERE
	TPE.DT_POSICAO_ESTOQUE BETWEEN SYSDATE - 15 AND SYSDATE AND TP2.DS_PRODUTO IS NOT NULL
UNION
SELECT
	...
	SUM( RLL.QT_SALDO) AS "QT_ESTOQUE",
...
LEFT JOIN
	DBHORUS.AU_RLLOCALFISICALOTEPRGSAUDE ar ON
	AR.CO_SEQ_LOCALFISICA_LOTPRGSAUDE = RLL.CO_SEQ_LOCALFISICA_LOTPRGSAUDE
WHERE
	NOT (RLL.QT_SALDO = 0 AND AR.AU_DT_OPERACAO < ADD_MONTHS(SYSDATE, -12))
GROUP BY 
	SUBSTR(TUD.CO_MUNICIPIO_IBGE, 0, 2),
	tu.SG_UF,
	TO_CHAR(TUD.CO_MUNICIPIO_IBGE),
	TM.NO_MUNICIPIO,
	TUD.CO_UNIDADE_CNES,
	TP4.NU_PRODUTO,
	TP4.DS_PRODUTO,
	TIL.NU_LOTE,
	TIL.DT_VALIDADE,
	TPS2.SG_PROGRAMA_SAUDE,
	TPS2.DS_PROGRAMA_SAUDE,
	TP4.TP_PRODUTO;